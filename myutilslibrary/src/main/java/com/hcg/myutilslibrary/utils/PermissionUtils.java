...
public final class PermissionUtils {
     ...
     */
    public static PermissionUtils permission(@PermissionConstants.Permission final String...
                                                     permissions) {
        return new PermissionUtils(permissions);
    }

    public static PermissionUtils permissionIt(String... permissions) {
        PermissionUtils permissionUtils = new PermissionUtils("");
        for (String permission : permissions) {
            if (PERMISSIONS.contains(permission)) {
                permissionUtils.mPermissions.add(permission);
            }
        }
    ...
    public static void showDialog(OnRationaleListener.ShouldRequest shouldRequest, String msg,
                                  Activity context) {
    ...
    public static void showGoToSettingDialog(String msg, Activity context) {
        new AlertDialog.Builder(context)
                .setTitle("提示")
                .setMessage(msg)
                .setNegativeButton("取消", (dialog, which) -> {
